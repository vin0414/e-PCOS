        ...
        <div class="row g-3">
            <?php foreach($blog as $row): ?>
                <div class="col-12">
                    ...
                    <h6><center><?php echo $row->Fullname ?>&nbsp;|&nbsp;<?php echo $row->Date ?></center></h6>
                </div>
                <div class="col-12">
                    <div class="row">
                        <div class="col-lg-4 form-group">
                        <img src="/Blogs/<?php echo $row->Image ?>" class="img-fluid" style="border-radius:5px 5px;box-shadow:2px 2px;;width:100%;padding:20px;border:1px solid gray;"/>
                        </div>
                        <div class="col-lg-8 form-group">
                        <div style="text-align: justify;"><?php echo $row->Details ?></div>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
