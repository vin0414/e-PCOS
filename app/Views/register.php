    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link active" href="<?=site_url('register')?>">Register</a></li>
        </ul>
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <?php endif; ?>
              <form method="POST" class="row mt-3" role="form" action="<?=base_url('create-account')?>">
              ...
              <p><small>Already Registered? Sign-In <a href="<?=site_url('login')?>">here</a></small></p>
            </div>
          </div>
        </div>
        <div class="col-lg-4"></div>
