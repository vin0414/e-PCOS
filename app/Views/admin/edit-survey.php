    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link active" href="javascript:void(0);">Update Survey</a></li>
    ...
    <section class="why-us">
      <div class="container">
        <div class="row g-3">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header"><span class="fa fa-list"></span>&nbsp;Edit Survey
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form method="post" class="row g-3" id="frmPoll" action="<?=base_url('update-poll')?>">
                            <?php if($survey): ?>
                            <input type="hidden" value="<?php echo $survey['surveyID'] ?>" name="id" required/>
                            <div class="col-12 form-group">
                                <label>Title</label>
                                <input type="text" class="form-control" value="<?php echo $survey['Title'] ?>" name="title_poll" required/>
                            </div>
                            <div class="col-12 form-group">
                                <label>Description (Optional)</label>
                                <textarea class="form-control" name="description" style="height:120px;"><?php echo $survey['Details'] ?></textarea>
                            </div>
                            <div class="col-12 form-group">
                                <label>Poll Type</label>
                                <select class="form-control" name="poll_type" required>
                                    <option value="">Choose</option>
                                    <option <?php if($survey['Type_Survey']=="Multiple Choice") echo 'selected="selected"'; ?>>Multiple Choice</option>
                                    <option <?php if($survey['Type_Survey']=="Ranking Poll") echo 'selected="selected"'; ?>>Ranking Poll</option>
                                </select>
                            </div>
                            <?php endif; ?>
                            <div class="col-12 form-group">
