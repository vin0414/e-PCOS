    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link active" href="javascript:void(0);">Edit Information</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" class="row g-3" id="frmEntry" enctype="multipart/form-data" action="<?=base_url('edit-entry')?>">
                            <?php if($info):?>
                            <input type="hidden" name="id" value="<?php echo $info['doctorID'] ?>"/>    
                            ...
                            <div class="col-12 form-group">
                                ...
                                <input type="text" class="form-control" name="specialty" value="<?php echo $info['Specialty'] ?>" required/>
                            </div>
                            <div class="col-12 form-group">
                                <label>Contact No</label>
                                <input type="phone" class="form-control" name="phone" value="<?php echo $info['Contact'] ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="11" minlength="11" required/>
                            </div>
                            <?php endif; ?>
                            <div class="col-12 form-group">
                                <button type="submit" class="form-control btn btn-primary" id="btnSave">Save Changes</button>
                            </div>
                        </form>
                    </div>
                </div>
