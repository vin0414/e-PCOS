    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link active" href="javascript:void(0);">Add Answer</a></li>
    ...
    <section class="why-us">
      <div class="container">
        <div class="row g-3">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header"><span class="fa fa-plus"></span>&nbsp;Add Answer
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form method="post" class="row g-3" id="frmAnswer" action="<?=base_url('save-answer')?>">
