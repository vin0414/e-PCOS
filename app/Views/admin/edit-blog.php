    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link active" href="javascript:void(0);">Edit Blog</a></li>
      ...
      <div class="container">
        <div class="row g-3">
            ...
            <div class="col-lg-10 form-group">
                <div class="card">
                    <div class="card-header"><span class="fa fa-pencil"></span>&nbsp;Edit Blog
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form method="post" class="row g-3" id="frmBlog" enctype="multipart/form-data" action="<?=base_url('update-blog') ?>">
                            <?php if($blog): ?>
                            <input type="hidden" value="<?php echo $blog['blogsID'] ?>" name="id"/>
                            <div class="col-12 form-group">
                                <label>Title</label>
                                <input type="text" class="form-control" value="<?php echo $blog['Title'] ?>" name="title_blog" required/>
                            </div>
                            <div class="col-12 form-group">
                                <label>Details</label>
                                <textarea class="form-control" name="description" style="height:250px;" required><?php echo $blog['Details'] ?></textarea>
                            </div>
                            <div class="col-12 form-group">
